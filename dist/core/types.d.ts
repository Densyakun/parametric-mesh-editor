...
export type NodeType = 'Model' | 'Parameter' | 'Variable' | 'Feature' | 'Function' | 'Interface';
export type FeatureCategory = 'primitive' | 'sketch' | 'transform' | 'modify' | 'boolean' | 'pattern' | 'material' | 'group';
export type OutputType = 'mesh' | 'selection' | 'sketch' | 'face' | 'edge' | 'vertex' | 'faceSet' | 'edgeSet' | 'vector' | 'point';
...
export type CommandType = 'parameter_change' | 'feature_add' | 'feature_remove' | 'feature_move' | 'dsl_edit';
